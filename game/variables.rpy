...
init python:
    ...
    class GameConfig:
        ...
        SPAWN_INTERVAL = 3.0        # segundos entre checks de spawn
        SPAWN_CUSTOMER_CHANCE = 0.25
    ...
    CUSTOMER_TYPES = [
        ...
        },
        {
            ...
            "line": "Seu sorriso está dentro dos padrões? Sorria mais!",
            "patience": 5,
            "emoji": "🕵️",
            "points": 40,
            "rarity": "rare"
        },
        {
            ...
            "line": "Executando protocolo de manutenção... Humanos são ineficientes.",
            "patience": 10,
            "emoji": "🤖",
            "points": 25,
            "rarity": "uncommon"
