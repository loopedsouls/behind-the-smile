...
image bg store_normal = im.Scale("images/mask/withmask.png", 1280, 720)
image bg store_alert = im.Scale("images/mask/inhandmask.png", 1280, 720)
image bg store_infected = im.Scale("images/mask/withoutmask.png", 1280, 720)
...
image bg store_unmasked_infected = im.Scale("images/mask/withoutmask.png", 1280, 720)
